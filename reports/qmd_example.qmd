...
![](../results/horse_pops_plot.png){#fig-horse_pops}
...
Additionally, note that in @fig-horse_pops we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops.

![](../results/horse_pop_plot_largest_sd.png){#fig-horse_largest_sd width=70%}
